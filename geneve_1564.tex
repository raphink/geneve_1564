...
\marginpar{\vspace{-23.5cm}\tiny
  \fakenote{m}{Ce mot deno-\linebreak
  te la distincti\~o \& \linebreak
  diversité des t\~eps \linebreak
  ord\~onés pour l'u- \linebreak
  sage des hommes: \linebreak
  soit pour le re- \linebreak
  gard de la religi\~o, \linebreak
  comme on voit à l'ordonnance des \linebreak
  solennités de Paſ- \linebreak
  ques, Pentecoste, \linebreak
  Tabernacles, Nou \linebreak
  velles lunes , ou \linebreak
  pour le regard de \linebreak
  la police, tant au public qu'au par- \linebreak
  ticulier.}
  \fakenote{n}{Qui sont dep\~e \linebreak
  dans du mouve- \linebreak
  ment du soleil. Or \linebreak
  le S.Esprit ne de- \linebreak
  claire point les se\-crets
  de nature \~q \linebreak
  l'astrologie ensei- \linebreak
  gne: ains seulem\~et \linebreak
  propose ce qui est \linebreak
  devant nos yeux, \linebreak
  c\~ome doctrine ge \linebreak
  nerale pour tous. \linebreak
  Car celui est le \linebreak
  vray livre,où mes- \linebreak
  mesles plus idiots \linebreak
  peuvent appr\~edre \linebreak
  à cognoistre Dieu.}
